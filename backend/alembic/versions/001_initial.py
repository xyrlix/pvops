...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_inverter_data_timestamp'), 'inverter_data', ['timestamp'], unique=False)
    op.create_index(op.f('ix_inverter_data_station_id'), 'inverter_data', ['station_id'], unique=False)
    op.create_index(op.f('ix_inverter_data_inverter_id'), 'inverter_data', ['inverter_id'], unique=False)
    ...
    op.create_index(op.f('ix_weather_data_station_id'), 'weather_data', ['station_id'], unique=False)
    ...
    op.create_index(op.f('ix_diagnosis_reports_station_id'), 'diagnosis_reports', ['station_id'], unique=False)
    ...
    op.create_index(op.f('ix_diagnosis_feedbacks_report_id'), 'diagnosis_feedbacks', ['report_id'], unique=False)
