...
async def list_alarms(
    ...
    """获取告警列表（仅当前租户）."""
    return await alarm_service.list_alarms(station_id, status, limit, tenant_id=tenant.tenant_id)
...
async def acknowledge_alarm(
    ...
    """确认告警."""
    success = await alarm_service.acknowledge_alarm(alarm_id, tenant_id=tenant.tenant_id)
...
async def close_alarm(
    ...
    """关闭告警."""
    success = await alarm_service.close_alarm(alarm_id, tenant_id=tenant.tenant_id)
    return {"success": success}
...
async def check_alarms(
    ...
    new_alarms = await alarm_service.check_alarms(station_id, tenant_id=tenant.tenant_id)
